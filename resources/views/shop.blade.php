                                ...
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="text-center mb-1 product-item__title"><a href="single-product-fullwidth.html" class="font-size-15 text-gray-90">Accessories</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="text-center mb-1 product-item__title"><a href="single-product-fullwidth.html" class="font-size-15 text-gray-90">All in One</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="text-center mb-1 product-item__title"><a href="single-product-fullwidth.html" class="font-size-15 text-gray-90">Gaming</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="text-center mb-1 product-item__title"><a href="single-product-fullwidth.html" class="font-size-15 text-gray-90">Laptops</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="text-center mb-1 product-item__title"><a href="single-product-fullwidth.html" class="font-size-15 text-gray-90">Mac Computers</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="text-center mb-1 product-item__title"><a href="single-product-fullwidth.html" class="font-size-15 text-gray-90">Peripherals</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="text-center mb-1 product-item__title"><a href="single-product-fullwidth.html" class="font-size-15 text-gray-90">Servers</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="product-item__outer h-100 w-100">
                                    <div class="product-item__inner px-xl-4 p-3">
                                        <div class="product-item__body pb-xl-2">
                                            ...
                                            <h5 class="text-center mb-1 product-item__title"><a href="single-product-fullwidth.html" class="font-size-15 text-gray-90">Ultrabooks</a></h5>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                                ...
                                                <div class="product-item__body pb-xl-2">
                                                    ...
                                                    <div class="flex-center-between mb-1">
                                                        ...
                                                        <div class="d-none d-xl-block prodcut-add-cart">
                                                            <a href="{{ route('shop.show', $product->slug) }}" class="btn-add-cart btn-primary transition-3d-hover"><i class="ec ec-add-to-cart"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <li class="col-6 col-md-3 col-wd-2gdot4 product-item">
                                        <div class="product-item__outer h-100">
                                            <div class="product-item__inner px-xl-4 p-3">
                                                <div class="product-item__body pb-xl-2">
                                                    <div class="mb-2"><a href="product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                    <h5 class="mb-1 product-item__title"><a href="{{ route('shop.show', $product->slug) }}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
                                                    <div class="mb-2">
                                                        <a href="{{ route('shop.show', $product->slug) }}" class="d-block text-center"><img class="img-fluid" src="../../assets/img/212X200/img1.jpg" alt="Image Description"></a>
                                                    </div>
                                                    <div class="mb-3">
                                        ...
                                        <div class="product-item__outer w-100">
                                            <div class="product-item__inner remove-prodcut-hover py-4 row">
                                                ...
                                                <div class="product-item__body col-6 col-md-5">
                                                    <div class="pr-lg-10">
                                                        <div class="mb-2"><a href="product-categories-7-column-full-width.html" class="font-size-12 text-gray-5">Speakers</a></div>
                                                        <h5 class="mb-2 product-item__title"><a href="{{ route('shop.show', $product->slug) }}" class="text-blue font-weight-bold">Wireless Audio System Multiroom 360 degree Full base audio</a></h5>
