                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <select name="state" class="form-control js-select selectpicker dropdown-select" required="" data-msg="Please select country." data-error-class="u-has-error" data-success-class="u-has-success"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" name="apartment" class="form-control" placeholder="YC7B 3UT" aria-label="YC7B 3UT" data-msg="Please enter a valid address." data-error-class="u-has-error" data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="js-form-message mb-6">
                                            ...
                                            <input type="text" name="phone" class="form-control" placeholder="+355 (06x) 109-9222" aria-label="+355 (06x) 109-9222" data-error-class="u-has-error" data-success-class="u-has-success">
                                        </div>
                                        <!-- End Input -->
                                    </div>
