                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="topbar-left">
                                <a href="#" class="text-gray-110 font-size-13 u-header-topbar__nav-link">Welcome to Armis Electronics Store</a>
                            </div>
                                                            ...
                                                            <li class="u-has-submenu u-header-collapse__submenu">
                                                                ...
                                                                <div id="headerSidebarDemosCollapse" class="collapse" data-parent="#headerSidebarContent">
                                                                    <ul id="headerSidebarDemosMenu" class="u-header-collapse__nav-list">
                                                                        ...
                                                                        <!-- Cart -->
                                                                        <li><a class="u-header-collapse__submenu-nav-link" href="{{ route('cart.index') }}">Cart</a></li>
                                                                        <!-- End Cart -->
