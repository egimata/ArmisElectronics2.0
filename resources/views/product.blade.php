                    ...
                    <div class="mx-md-auto mx-lg-0 col-md-6 col-lg-4 col-xl-3">
                        <div class="mb-2">
                            <div class="card p-5 border-width-2 border-color-1 borders-radius-17">
                                ...
                                <div class="mb-3">
                                    <div class="font-size-36">${{ number_format($product->price) }}</div>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-2 pb-0dot5">
                                    <form action="{{ route('cart.store') }}" method="POST">
                                        ...
                                        <button type="submit" class="btn btn-block btn-primary-dark"><i class="ec ec-add-to-cart mr-2 font-size-20"></i> Add to Cart</a>
                                    </form>
                                </div>
                                <div class="mb-3">
